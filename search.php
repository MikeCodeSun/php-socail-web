<?php
  ...
  require 'db.php';
  // $name = "%" . 'm' . "%";
  // $search_user_query = sprintf("SELECT * FROM users WHERE name LIKE '%s'", mysqli_real_escape_string($conn, $name));
  // $result = mysqli_query($conn, $search_user_query);
  $result = null;
  ...
  <div class='col-md-8 mx-auto mt-5' >
    ...
    <?php
      if($result && mysqli_num_rows($result) > 0){
        ...
        echo "<div class='text-center fs-1 mt-5'> No search Result </div>";
      }
    ?>
    </div>
    </div>
